...
namespace System.Web.Mvc.Html
{
    public static class HtmlHelperExtensions
    {
        ...
        public static HtmlTag LinkTo(this HtmlHelper html, string controller, string text, object model = null,
            string action = "get", bool urlEncoded = true)
        {
            var url = new UrlHelper(html.ViewContext.RequestContext);
            return url.LinkTo(controller, text, model, action, urlEncoded);
        }
